  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-base text-sm font-sans font-medium ring-offset-white transition-all gap-2 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-border bg-background text-foreground shadow-none hover:bg-neutral-50",
      },
      size: {
